			...
			<div class="problems-card-edit" v-show="showEdit">
		        <div class="problems-card-tabs">
		        	<div class="problems-card-tabs-item" @click="editTabShown = 1" :class="{ active: editTabShown == 1 }">
		        		<img class="active" src="~/static/problems/others-card-partner-active.svg">
		        		<img class="passive" src="~/static/problems/others-card-partner-passive.svg">
		        	...
		        	<div class="problems-card-tabs-item" @click="editTabShown = 3" :class="{ active: editTabShown == 3 }">
		        ...
		        <div class="problems-card-tab" v-show="editTabShown == 1">
		        	<span class="problems-card-msg"><span class="bold">Александр</span> пригласил вас для решения проблемы.</span>
		        	<span class="problems-card-msg"><span class="bold">Александр</span> запросил у вас ресурсы:</span>
		        	<div class="problems-card problems-card--edit">
		        		<div class="pic-area"></div>
			        	<div class="info-area"></div>
		        	</div>
		        	<button class="problems-card-confirm">
		        		<span>Принять</span>
		        	</button>
	        	</div>
		        <div class="problems-card-tab about-problem" v-show="editTabShown == 2">
		        	<div class="about-problem-infos">
			        	...
			        	<div class="about-problem-info">
			        		...
			        		<span class="about-problem-info-text">город</span>
			        	</div>
			        	<div class="about-problem-info">
		        ...
		        <div class="problems-card-tab solutions" v-show="editTabShown == 3">
		        	...
		        	<div class="solutions-modal" v-show="showSolutionsModal">
		        		<div class="solutions-modal-inner">
		        			...
		        			<div class="step5-resource-description solutions-description">
								...
								<div class="step5-textarea">
									<textarea maxlength="1000" placeholder="текст"></textarea>
								</div>
							</div>
							...
							<button class="step5-modal-button solutions-button" @click="showSolutionsModal = false"><span>Опубликовать</span></button>
		        		</div>
		        	</div>
	        	</div>
		    </div>
